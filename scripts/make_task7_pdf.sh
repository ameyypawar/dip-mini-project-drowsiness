#!/usr/bin/env bash
# Render docs/task7_report.html to a PDF using headless Chrome (Task 7 report,
...
HTML_PATH="${ROOT_DIR}/docs/task7_report.html"
PDF_PATH="${ROOT_DIR}/submissions/Task7_Region_Growing.pdf"
