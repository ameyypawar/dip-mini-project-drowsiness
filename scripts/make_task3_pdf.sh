#!/usr/bin/env bash
# Render docs/task3_report.html to a PDF using headless Chrome (Task 3 report,
# institutional lab-template format). Mirrors scripts/make_task4_pdf.sh's
...
HTML_PATH="${ROOT_DIR}/docs/task3_report.html"
PDF_PATH="${ROOT_DIR}/submissions/Task3_Image_Enhancement.pdf"
