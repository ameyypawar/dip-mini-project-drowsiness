#!/usr/bin/env bash
# Render docs/task5_report.html to a PDF using headless Chrome (Task 5 report,
...
HTML_PATH="${ROOT_DIR}/docs/task5_report.html"
PDF_PATH="${ROOT_DIR}/submissions/Task5_Sharpening_Filters.pdf"
