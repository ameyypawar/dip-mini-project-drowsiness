#!/usr/bin/env bash
# Render docs/task2_report.html to a PDF using headless Chrome (Task 2 report,
# institutional lab-template format). Mirrors scripts/make_task6_pdf.sh's
...
HTML_PATH="${ROOT_DIR}/docs/task2_report.html"
PDF_PATH="${ROOT_DIR}/submissions/Task2_Image_Fundamentals.pdf"
